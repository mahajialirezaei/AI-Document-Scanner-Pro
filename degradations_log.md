...
* **Synthetic Binder Margins (Pruned/Moderated):** Previously included thick folder borders, but pruned from active training loops to prevent geometric confusion and overfitting to artificial edge artifacts.
...
* **Corner Occlusion by Dark Objects (Pruned/Moderated):** Severely destructive corner occlusions were disabled to preserve model confidence, transitioning instead to moderated sleeve/clothing occlusions constrained with lower probabilities and wider spatial margins from true corners.
