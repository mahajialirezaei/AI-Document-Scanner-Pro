...
* Split the synthetic data source scans into 80% Training, 10% Validation, and 10% Test sets.
...
* Run an OCR engine like Tesseract on the real photo inputs, your enhanced outputs, and the reference scans to calculate readablity improvements.



## Phase 6: Regularization & End-to-End Bonus
